...
export default function Timer({ targetTime = 61 }) {
    ...
    return <div className="self-center select-none min-w-[250px] ">
        <div className="flex flex-row justify-center w-full text-4xl bg-[#5522A9] text-white py-2 transform rotate-3 shadow-[#5522A9]   shadow-2xl px-4 rounded-xl">
